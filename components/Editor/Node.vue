  ...
  <div :class="{ 'permission-node': true, modified: source.modified, new: source.isNew }">
    ...
    >
      <span v-if="flattenedContexts.length">
        <code v-for="(entry, index) in flattenedContexts" :key="index"><small>{{ entry.key }}:</small> {{ entry.value }}</code>
      </span>
    ...
    <transition name="fade">
      <div v-if="context.ui" class="context-ui" v-click-outside="closeContextUi">
        ...
        <ul>
          <li v-for="(entry, index) in flattenedContexts" :key="index">
            <span>{{ entry.key }}</span>
            ...
            <div class="edit">
              ...
              <transition name="fade">
                <ul class="context-list" v-if="context.keyFocus">
                  <li
                    v-for="(pContext, index) in potentialContexts"
                    :key="index"
            ...
            <div class="edit">
              ...
              <transition name="fade">
                <ul class="context-list" v-if="context.valueFocus">
                  <li
                    v-for="(value, index) in potentialContextValues"
                    :key="index"
