...
export default {
  ...
  head: {
    title: 'Download',
    meta: [
      { hid: 'description', name: 'description', content: 'Download the newest LuckPerms version now.' },
      { hid: 'twitter:description', name: 'twitter:description', content: 'Download the newest LuckPerms version now.' },
      { hid: 'og:description', name: 'og:description', content: 'Download the newest LuckPerms version now.' },
    ],
  },
  components: {
