  ...
  <main class="editor">
    <client-only>
      <div class="editor-container">
          <!--<ToolIntro v-if="!sessions.length" :error="errors.load" loading="true" />-->
          
          <!-- if="sessions.length" -->
          <div class="editor-wrap" :key="sessionId">
            <editor-menu
              :sessions="sessions"
...
export default {
  head: {
    title: 'Editor',
    meta: [
      { hid: 'description', name: 'description', content: 'Edit your permissions fast and easy.' },
      { hid: 'twitter:description', name: 'twitter:description', content: 'Edit your permissions fast and easy.' },
      { hid: 'og:description', name: 'og:description', content: 'Edit your permissions fast and easy.' },
    ],
  },
  components: {
    EditorMenu,
  ...
  created() {
    ...
    this.updateSession($route, 'getEditorData');
  },
  watch: {
    $route(route) {
      this.updateSession(route, 'getEditorData');
