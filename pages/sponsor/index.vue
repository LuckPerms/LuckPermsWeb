...
export default {
  ...
  head: {
    title: 'Sponsor',
    meta: [
      { hid: 'description', name: 'description', content: 'Learn more about LuckPerms\' sponsor BisectHosting' },
      { hid: 'twitter:description', name: 'twitter:description', content: 'Learn more about LuckPerms\' sponsor BisectHosting' },
      { hid: 'og:description', name: 'og:description', content: 'Learn more about LuckPerms\' sponsor BisectHosting' },
    ],
  },
  data() {
    return {
